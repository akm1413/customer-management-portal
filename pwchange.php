				...
				<span class="navbar-toggler-icon"></span>
					...
					<div class = "collapse navbar-collapse" id = "myNavbar">
						<ul class = "navbar-nav navbar-right">
							<li><a href = "#"><a href = "register.html"><span class = "glyphicon glyphicon-user"></span>&nbsp;&nbsp;Register&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a></li>
						...
						<ul class="dropdown-menu">
							<li><a href="index.html">As a customer</a></li>
							<li><a href="admin.html">As an admin</a></li>
						</ul>
					</li>
						</ul>
					</div>
			...
			<div class="wrap-contact4">
				<div class = "content">
					<span class="contact3-form-title">
						<br><br><h2>Password has been changed successfully.</h2><br>
