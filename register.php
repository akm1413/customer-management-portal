...
<body>
				...
				<span class="navbar-toggler-icon"></span>
					...
					<div class = "collapse navbar-collapse" id = "myNavbar">
						...
						<ul class="dropdown-menu">
							<li><a href="login.php">As a customer</a></li>
		...
		<div class="container-contact3">
			<div class="wrap-contact3">
				...
				<form class="contact3-form validate-form" action="custregistration.php" method="post" name="f1">
					<span class="contact3-form-title">
						Customer Registration
					</span>

					<div class="wrap-input3 validate-input" data-validate="Item name is required">
						<input class="input3" type="text" name="name" placeholder="Customer Name" required/>
						<span class="focus-input3"></span>
					</div>

					<div class="wrap-input3 validate-input" data-validate="Correct email is required"/>
					...
					<div class="wrap-input3 validate-input" data-validate="Enter a proper password"/>
						<input class="input3" type="password" name="password" placeholder="Enter a password" required >
						<span class="focus-input3"></span>
					</div>

					<div class="wrap-input3 validate-input" >
						<input class="input3" type="text" name="contact" placeholder="Contact Number"/>
						<span class="focus-input3"></span>
					</div>

          			<div class="wrap-input3 validate-input" data-validate="Address is required">
						<input class="input3" type="text" name="add1" placeholder="Address Line 1" required/>
						<span class="focus-input3"></span>
					</div>

         			 <div class="wrap-input3 validate-input">
						<input class="input3" type="text" name="add2" placeholder="Address line 2 (Optional)"/>
						<span class="focus-input3"></span>
					</div>
